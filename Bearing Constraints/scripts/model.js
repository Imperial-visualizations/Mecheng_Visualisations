    ...
    if (design.drag[i].part) {
      if (part == 'spacer') {
        ...
        for (let j=limits[2*partName.indexOf(part)]; j<limits[2*partName.indexOf(part)+1]; j++) {
          ...
          /*
          if (con.state[j] && sign*move.x > 0 && design.drag[partName.indexOf('leftBearing')].part) {
            if (j < 2) {
              return design.drag[partName.indexOf('leftBearing')].drawX(x);              
            }
            if (j >= 2) {
          ...
          if (con.state[j] && sign*move.x < 0 && design.drag[partName.indexOf('rightBearing')].part) {
            if (j >= 2) {
              return design.drag[partName.indexOf('rightBearing')].drawX(x);              
            }
            if (j < 2) {
...
/*
          if (con.state[j] && design.drag[partName.indexOf('leftBearing')].part) {
            if ((con.state[j] && con.state[j-2+sign] && sign*move.x > 0)) {
              console.log(part)
              return design.drag[partName.indexOf('rightBearing')].drawX(x);
            }
       ...
       //     }
            //if (j >= 2 && sign*move.x > 0) {
              //if (con.state[j] == con.state[j-2+sign]) {
                //return design.drag[partName.indexOf('rightBearing')].drawX(x);
              //}
            //}
          ...
          else if (con.state[j] && part && design.drag[partName.indexOf('leftBearing')].part) {
            if (j < 2 && sign*move.x < 0) {
              return design.drag[partName.indexOf('leftBearing')].drawX(x);              
            }
            else if (j >= 2 && sign*move.x > 0) {
              if (con.state[j] == con.state[j-2+sign]) {
                return design.drag[partName.indexOf('shaft')].drawX(x);
              }
            }
          }
          else if (con.state[j] && part && design.drag[partName.indexOf('rightBearing')].part) {
            if (j >= 2 && sign*move.x < 0) {
              return design.drag[partName.indexOf('rightBearing')].drawX(x);              
            }
            else if (j < 2 && sign*move.x > 0) {
          ...
          /*
          else if (con.tag[1] == 'spacer' && !con.state[0] && move.x < 0 && part == 'leftBearing') {
            return design.drag[partName.indexOf('rightBearing')].drawX(x); 
          }
          else if (con.tag[1] == 'spacer' && !con.state[0] && move.x > 0 && part == 'rightBearing') {
            return design.drag[partName.indexOf('leftBearing')].drawX(x);
          }*/